...
export default function ExportCalendar({calendar_id}: {calendar_id: string}){
    ...
    return(
        <div className="bg-white shadow-md rounded px-2 sm:px-8 py-4 my-4 flex flex-wrap">
            <div className='m-2 border rounded shadow-md hover:shadow-lg grow cursor-pointer bg-gray-50 group flex justify-between'>
            ...
            <a className='bg-gray-50 border shadow-md hover:shadow-lg p-4 h-12 sm:h-14 m-2 grow rounded hover:bg-white cursor-pointer text-sm sm:text-base flex items-center justify-center'
